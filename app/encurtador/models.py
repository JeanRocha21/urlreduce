...
class Urlsredirect(models.Model):
...
class UrlLog(models.Model):
    ...
    user_age = models.CharField(max_length=512,null=True, blank=True)
    host = models.CharField(max_length=512,null=True, blank=True)
    ip = models.GenericIPAddressField(null=True, blank=True)
    url_redirect = models.ForeignKey(Urlsredirect, models.DO_NOTHING, related_name='logs')
