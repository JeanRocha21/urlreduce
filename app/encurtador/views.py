...
def redirecionar(requisicao, slug):
    ...
    UrlLog.objects.create(
        origem = requisicao.META.get('HTTP_REFETET'),
        user_age = requisicao.META.get('HTTP_USER_AGENT'),
